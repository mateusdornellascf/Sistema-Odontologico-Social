...
INSERT INTO pessoa (CPF, nome, dataNascimento, CEP, rua, bairro, numero) VALUES 
('12345678901', 'João Silva', '1990-05-10', '50000-000', 'Rua das Flores', 'Boa Viagem', 101),
...
('99988877766', 'Pedro Santos', '2000-01-20', '54000-000', 'Rua do Comércio', 'Centro', 505);

INSERT INTO telefone (cpfPessoa, numero) VALUES
...
INSERT INTO paciente (CPF, planoSaude) VALUES
('12345678901', 'PLANO123'),
('98765432100', 'PLANO456'),
('11122233344', 'PLANO789');

INSERT INTO dentista (CPF, CRO, especialidade, email, cpfCoordenador) VALUES
...
INSERT INTO procedimento (idProcedimento, idConsulta, tipo, descricao) VALUES
(1, 1, 'Limpeza', 'Limpeza dentária simples'),
(2, 2, 'Extração', 'Remoção de dente'),
(3, 3, 'Clareamento', 'Clareamento dental');

INSERT INTO cirurgico (idProcedimento, dataCirurgia, cpfDentista, valor) VALUES
(2, '2026-04-02', '99988877766', 500.00);

INSERT INTO estetico (idProcedimento, sessoes, dataInicio, valor) VALUES
(3, 3, '2026-04-10', 800.00);

INSERT INTO rotina (idProcedimento, dataRotina, status, valor) VALUES
